	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1:
				...
				f = new Food(foodName, foodType, foodPrice, foodQuantity, foodCategory, foodDescription, foodRating);
			...
			case 2:
				...
				if (flist != null && flist.isEmpty() != true)
					flist.forEach(s -> System.out.println("\n------------------------------------------------" + s));
				else
			...
			case 3:
				...
				if (f != null) {
					...
					boolean b = false;
					do {
						System.out.println("Do you want to update this Food Item. [Yes/No] : ");
